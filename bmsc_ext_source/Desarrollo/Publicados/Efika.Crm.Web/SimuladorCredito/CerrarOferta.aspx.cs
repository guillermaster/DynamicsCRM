    ...
    public partial class CerrarOferta : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (OfertaConOportunidadesMontoCero(numeroOferta))
                {
                    ...
                    //negOferta.CerrarOferta(numeroOferta, evalScoreRes);
                }
                else
                {
        ...
        private Entidades.EvaluacionScore GetEvalScoreResult(Guid idCliente)
        {
            try
            {
                ...
                //Entidades.EvaluacionScore score = negScoreEval.GetEvaluacionScoreClienteMasReciente(idCliente);
                //return score;
                return null;
            }
            catch (Exception ex)
        ...
        private bool OfertaConOportunidadesMontoCero(int numOferta)
        {
            try
            {
                ...
                //return negOferta.OfertaTieneOportunidadesMontoCero(numOferta);
                return false;
            }
            catch (Exception ex)
            {
