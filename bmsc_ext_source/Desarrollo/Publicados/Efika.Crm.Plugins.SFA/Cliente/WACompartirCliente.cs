...
{
    public class WACompartirCliente: CodeActivity
    {
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            try
            {
                ...
                if (IdCliente.Get(executionContext) != null)
                {
                    idCliente = IdCliente.Get(executionContext).Id;
                }

                if ((idEquipo != Guid.Empty || idUsuario != Guid.Empty) && idCliente != Guid.Empty)
                {
                    ...
                    if (compartir)
                    {
                        ...
                        ga.Target = new EntityReference("account", idCliente);
                    ...
                    if (descompartir)
                    {
                        ...
                        ra.Target = new EntityReference("account", idCliente);
        ...
        public InArgument<EntityReference> IdCliente { get; set; }
