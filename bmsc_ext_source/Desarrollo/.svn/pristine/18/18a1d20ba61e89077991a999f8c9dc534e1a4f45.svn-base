...
public class DPAPI
{
    ...
    public static CredencialesCRM ObtenerUsuarioPasswordDPAPI(string rutaArchivo, string organizacion, string dominio)
    {
        string descripcion;
        ...
        string dato = doc.ChildNodes[1].ChildNodes[2].InnerText;

        string usuario = DPAPI.Decrypt(dato,null,out descripcion);

        
        dato = doc.ChildNodes[1].ChildNodes[3].InnerText;

        string password = DPAPI.Decrypt(dato,null,out descripcion);

        CredencialesCRM credenciales = new CredencialesCRM();
        credenciales.Dominio = dominio;
        credenciales.Organizacion = organizacion;
    ...
    public static CredencialesBD ObtenerVariablesConexionBDDPAPI(string rutaArchivo)
    {
        string descripcion;
        ...
        string dato = doc.ChildNodes[1].ChildNodes[0].InnerText;

        string servidor = DPAPI.Decrypt(dato, null, out descripcion);

        dato = doc.ChildNodes[1].ChildNodes[1].InnerText;

        string catalogo = DPAPI.Decrypt(dato, null, out descripcion);

        dato = doc.ChildNodes[1].ChildNodes[2].InnerText;
        ...
        credenciales.Servidor = servidor;
        credenciales.Catalogo = catalogo;
        credenciales.Usuario = usuario;
        credenciales.Password = password;
