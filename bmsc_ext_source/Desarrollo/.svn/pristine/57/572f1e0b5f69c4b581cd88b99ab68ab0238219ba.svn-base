...
{
    public partial class rptScorePuntuacion : System.Web.UI.Page
    {
        ...
        public void MostrarReporte(string numSolicitud)
        {
            ...
            Guid idReport = negReporte.obtenerIdReporte(ConfigurationManager.AppSettings["ReporteScorePuntuacion"]);
