<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReabrirOfertaGerentes.aspx.cs" Inherits="Efika.Crm.Web.SimuladorCredito.ReabrirOfertaGerentes" %>
...
<body>
    ...
    <div style="position: absolute; top: 50; left: 50; width: 100%; height: 100%; z-index: 100">
