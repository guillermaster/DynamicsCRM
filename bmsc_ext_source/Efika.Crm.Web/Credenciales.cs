...
namespace Efika.Crm.Web
{
    public class Credenciales
    {
        public static CredencialesCRM ObtenerCredenciales()
        {
            ...
            credenciales = new CredencialesCRM();
            credenciales.Dominio = "CRM";
            credenciales.Organizacion = "BMSC";
            credenciales.Password = "Ad123456";
            credenciales.Usuario = "Administrator";
